...
public class CalculatorController {
    ...
    String potentiation(@RequestParam("base") Integer base, @RequestParam("exponent") Integer exponent) {
        return String.valueOf(calculatorService.potentiation(base, exponent));
    }
}
